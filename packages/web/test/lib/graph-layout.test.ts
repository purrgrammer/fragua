...
describe("layoutDag", () => {
  ...
  it("defaults to TB when orientation is omitted", () => {
    const input = {
      nodes: [{ id: "a" }, { id: "b" }],
      edges: [{ from: "a", to: "b", iteration: 0, pass: 0 }],
    };
  ...
  it("spreads siblings across the perpendicular axis centred on 0", () => {
    const input = {
      ...
      edges: [
        { from: "s", to: "a", iteration: 0, pass: 0 },
        { from: "s", to: "b", iteration: 0, pass: 0 },
        { from: "s", to: "c", iteration: 0, pass: 0 },
      ],
    };
    const tb = layoutDag(input, { orientation: "TB" });
  ...
  it("degrades gracefully on a cycle (no throw, every node positioned)", () => {
    const input = {
      ...
      edges: [
        { from: "a", to: "b", iteration: 0, pass: 0 },
        { from: "b", to: "a", iteration: 0, pass: 0 },
      ],
    };
    const out = layoutDag(input);
  ...
  it("picks up ids that appear only in edges (defensive union)", () => {
    const input = { nodes: [{ id: "a" }], edges: [{ from: "a", to: "b", iteration: 0, pass: 0 }] };
    const out = layoutDag(input);
