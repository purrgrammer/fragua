...
// values, zero, non-finite numbers, and anything that doesn't match the
// grammar throw with a caller-friendly message.
 ...
 *
 * Throws `InvalidDurationError` on empty string, negative numbers, zero,
