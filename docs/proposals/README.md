...
| [JSON IR as the canonical workflow form](./json-ir-canonical.md) | designed | promote the in-memory `Graph` IR to the canonical interchange form; DOT remains the authoring surface but the engine accepts JSON directly |
